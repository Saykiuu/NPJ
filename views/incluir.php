...
<head>
    ...
    <script>
        function escolher(){alert("escolha um dado!")}
    </script>
</head>
...
<body>
    ...
    <form id="formulario-cadastro" method="post" action="processo.cadastro.php">
        ...
        <div class="campos" id="nav-cliente">
            ...
            <input type="text" class="full" id="inp-cliente-nome" name="cli-nome" autocomplete="off" required placeholder="Nome">

            <label for="inp-cliente-end" class="label-full">Endereço:</label>
            <input type="text" id="inp-cliente-end" class="full" name="cli-endereco" autocomplete="off" required>

            <fieldset class="fds">

                <label for="inp-cliente-cpf" class="label-half">CPF:</label>
                <input type="text" class="half" id="inp-clientes-cpf" name="cli-cpf" autocomplete="off" required>

                <label for="inp-cliente-rg" class="label-half">RG:</label>
                <input type="text" class="half" id="inp-cliente-rg" name="cli-rg" autocomplete="off" required>

                <label for="inp-cliente-ssp" class="label-half">SSP/:</label>
                <input type="text" class="half" id="inp-cliente-ssp" name="cli-ssp" autocomplete="off" required>
            ...
            <fieldset class="fds">
                ...
                <input type="date" class="half" id="inp-cliente-nasc" name="cli-nasc" autocomplete="off" required>

                <label for="inp-cliente-tel" class="label-half">telefone:</label>
                <input type="tel" class="half" id="inp-cliente-tel" name="cli-tel" autocomplete="off" required>
            </fieldset>



            <label for="inp-cliente-email" class="label-full">Email:</label>
            <input type="email" class="full" id="inp-cliente-email" name="cli-email" autocomplete="off" required>

            <fieldset class="fds">


                <label for="inp-cliente-civil" class="label-half">Estado Civil:</label>
                <input type="text" class="half" id="inp-cliete-civil" name="cli-civil" autocomplete="off" required>


                <label for="inp-cliente-prof" class="label-half">Profissão:</label>
                <input type="text" class="half" id="inp-cliente-prof" name="cli-prof" autocomplete="off" required>
